...
class ProviderViewController: MenuContainerViewController {
    ...
    override func viewDidLoad() {
        ...
        menuViewController = self.storyboard!.instantiateViewController(withIdentifier: "NavigationMenu") as! NavigationMenuViewController
    ...
    private func contentControllers() -> [MenuItemContentViewController] {
        ...
        contentList.append(self.storyboard?.instantiateViewController(withIdentifier: "AvailabilityViewController") as! MenuItemContentViewController)
        contentList.append(self.storyboard?.instantiateViewController(withIdentifier: "CategoryViewController") as! MenuItemContentViewController)
